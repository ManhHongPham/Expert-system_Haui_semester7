...
namespace DieuCheHoaHoc
{
    public partial class DieuCheForm : Form
    {
        ...
        private void initCurChemical() {
            lbxCurChemical.Items.Add("N2");
            lbxCurChemical.Items.Add("H2");
        }
        ...
        private void lbxCurChemical_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void lbxSavedChemical_SelectedIndexChanged(object sender, EventArgs e)
        {
